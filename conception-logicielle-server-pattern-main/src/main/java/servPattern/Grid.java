...
import launchPattern.ProtocoleManageGame;
import launchPattern.ProtocolePlayChecker;
...
public class Grid implements IGrid, Serializable {
    ...
    private IDemandePlayChecker strategyPlay;
    private IDemandeManageGame strategyManage;
    /**
    ...
    public Grid(int width, int height, IDemandePlayChecker strategyPlay, IDemandeManageGame strategyManage) {
        this(width, height);
...
//        serveurGame.getNotifier().firePropertyChange("iPlayed", checkerSave , color);
    ...
    public void startGame() {
        serveurs.add(new ServeurTCP(this, new ProtocoleGame(), port));
        //serveurs.add(new ServeurTCP(this, new ProtocoleManageGame(), hport));
    ...
    public int demandePlay(int columnNumber, String color) {
        return strategyPlay.demandePlay(columnNumber, color, this);
    }

    public String demandeColor() {
        return strategyManage.demandeColor(this);
    }

    public String demandeTurn() {
        return strategyManage.demandeTurn(this);
    }

    public Grid demandeGrid() {
        return strategyManage.demandeGrid(this);
    }
}
