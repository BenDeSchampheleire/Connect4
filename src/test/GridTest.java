...
class GridTest {
    ...
    void checkWin() {
        ...
        g3.play_checker(1,"yellow");
        g3.play_checker(2,"yellow");
        g3.play_checker(2,"yellow");
        g3.play_checker(3,"yellow");
        g3.play_checker(3,"yellow");
        g3.play_checker(3,"yellow");
        g3.play_checker(4,"yellow");
        g3.play_checker(4,"yellow");
        g3.play_checker(4,"yellow");
        g3.play_checker(4,"yellow");
        ...
        // we verify the \-diagonal win
        g4.play_checker(1,"yellow");
        g4.play_checker(1,"yellow");
        g4.play_checker(1,"yellow");
        g4.play_checker(1,"yellow");
        g4.play_checker(2,"yellow");
        g4.play_checker(2,"yellow");
        g4.play_checker(2,"yellow");
        g4.play_checker(3,"yellow");
        g4.play_checker(3,"yellow");
        g4.play_checker(4,"yellow");
        assertTrue(g4.checkWin("yellow"));

        // we create a new grid
        Grid g5 = new Grid(7, 6);
        // we verify using checkers of different colors
        g5.play_checker(1,"yellow");
        g5.play_checker(1,"yellow");
        g5.play_checker(1,"red");
        g5.play_checker(1,"yellow");
